...
Public Class usrpms25
    ...
    Public Overridable Sub usrpdfpage_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        grid.Columns("CPATH").Width = 200
        grid.Columns("CPATH").ReadOnly = True

        grid.Columns.Add("CFNAME", "FILE NAME")
        grid.Columns("CFNAME").Width = 300
        grid.Columns("CFNAME").ReadOnly = True

        grid.Columns.Add("CTP", "TOTAL PAGES")
        grid.Columns("CTP").Width = 100
        grid.Columns("CTP").ReadOnly = True
        grid.Columns("CTP").CellTemplate.Style.Alignment = DataGridViewContentAlignment.MiddleCenter

        grid.Columns.Add("CPTM", "PAGES TO MERGE")
        grid.Columns("CPTM").Width = 200
        grid.Columns("CPTM").CellTemplate.Style.ForeColor = Color.Green
    ...
    Private Sub usrpms25_MouseWheel(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles grid.MouseWheel
    ...
    Private Sub pms5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles pms5.Click
        frmPMS.changeto5()
    End Sub
End Class
